...
import { createUserWithEmailAndPassword } from "firebase/auth"; // Certifique-se de que está importando corretamente
...
async function handleSignUp(e) {
  ...
  try {
    ...
    // Exibindo sucesso e redirecionando
    sucess_cad(); 
    clearFields();
    setIsActive(false);
...
async function handleSignIn(e) {
  ...
  try {
    ...
    if (userName) {
      ...
      fail(); // Chama a função fail em caso de erro
    }
  } catch (error) {
...
// Função para buscar o nome do usuário no Firestore Funciona
