...
import { dontSavePdf, savePdf, ainda_nao } from "../../services/alert.js";
...
export default function Practice() {
  ...
  const { userName } = useUser();  // Acessar o nome do usuário pelo contexto
  ...
  function generateInvoicePDF({ clientAddress, clientPhone, clientEmail, invoiceNum, activityName, score, level, timeSpent, answers }) {
    const props = {
